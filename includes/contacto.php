			...
			<section>
				<div class="iw">
					<article class="zona formulario">
						...
						<div id="formZone">
							<form name="fvalida" id="formaFormat" method="post" enctype="application/x-www-form-urlencoded" action="contacto_resp.php" target="_self">
								...
								<div class="tresCuartosIn rigthPadd">
									<label for="telefono" class="tTelefono">Número Teléfonico:</label>
								...
								<textarea name="comentario" id="comentario" cols="30" rows="10" class="input"></textarea>
